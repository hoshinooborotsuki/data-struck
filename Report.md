...
==== 測試檔案: Random ====
資料量 1000，執行 10000 次，總耗時: 94.54800 秒，平均每次: 945.48410000 微秒
資料量 5000，執行 2000 次，總耗時: 295.28000 秒，平均每次: 14764.01150000 微秒
資料量 10000，執行 1000 次，總耗時: 479.34800 秒，平均每次: 47934.82100000 微秒
資料量 20000，執行 500 次，總耗時: 927.91700 秒，平均每次: 185583.42200000 微秒

==== 測試檔案: Order ====
資料量 1000，執行 10000 次，總耗時: 0.19600 秒，平均每次: 1.96220000 微秒
資料量 5000，執行 2000 次，總耗時: 0.21700 秒，平均每次: 10.85350000 微秒
資料量 10000，執行 1000 次，總耗時: 0.20700 秒，平均每次: 20.71100000 微秒
資料量 20000，執行 500 次，總耗時: 0.34700 秒，平均每次: 69.35600000 微秒

==== 測試檔案: sOrder ====
資料量 1000，執行 10000 次，總耗時: 98.20300 秒，平均每次: 982.03060000 微秒
資料量 5000，執行 2000 次，總耗時: 478.69400 秒，平均每次: 23934.68150000 微秒
資料量 10000，執行 1000 次，總耗時: 1251.58800 秒，平均每次: 125158.76100000 微秒
資料量 20000，執行 500 次，總耗時: 5189.15500 秒，平均每次: 1037831.08200000 微秒
```
## Heap Sort 函數
```
void heapSort(vector<int>& working, const vector<int>& original)
...
| 15000  | 1038.13148649 μs | 159.63680180 μs| 922.45448949 μs  |
...
| 數量\情況 | 順序(最好) | 隨機 | 反序(最壞) |
|:------:|:----------------:|:--------------:|:----------------:|
| 1000   | 29.73030700 μs   | 8.07820900 μs  | 20.66399600 μs   |
| 2000   | 59.09094800 μs   | 18.95751000 μs | 55.89797200 μs   |
| 3000   | 90.37575158 μs   | 34.12411941 μs | 67.52663066 μs   |
| 4000   | 172.73452000 μs  | 51.53068800 μs | 66.92814000 μs   |
| 5000   | 282.72260000 μs  | 107.72080000 μs| 86.70708500 μs   |
| 6000   | 369.20190876 μs  | 124.67073229 μs| 121.99939376 μs  |
| 7000   | 443.44075630 μs  | 154.48853641 μs| 161.60677171 μs  |
| 8000   | 515.59720800 μs  | 181.78060000 μs| 163.04152000 μs  |
| 9000   | 432.00558056 μs  | 219.02584158 μs| 197.67295230 μs  |
| 10000  | 351.71308000 μs  | 263.26590000 μs| 216.82935000 μs  |
| 15000  | 538.51591592 μs  | 338.40569069 μs| 328.30618619 μs  |
| 20000  | 768.21690000 μs  | 422.88204000 μs| 468.25850000 μs  |
